...
(function () {
	...
	let translate = function () {
		...
		browserMM.addMessageListener('getSelection', function listener(message) {
			...
			if (t) {
				openWebLinkIn('https://translate.google.com/#view=home&op=translate&sl=auto&tl=en&text=' + encodeURIComponent(message.data), 'tab');
			} else {
				openWebLinkIn('https://translate.google.com/translate?u=' + encodeURIComponent(gBrowser.currentURI.spec) + '&hl=en-US&ie=' + e + '&sl=auto&tl=de-DE', 'tab');
			};
	...
	menuitem.setAttribute('label', 'Translate Selection in New Tab');
	menuitem.setAttribute('tooltiptext', 'Translate with GoogleTranslate');
