        ...
        onpopupshowing: function() {
            ...
            for (var i = 0; i < this.toolbar.subdirs.length; i++) {
                if (this.toolbar.subdirs[i].name == 'separator') {
                    ...
                    subDirItem.setAttribute('image', this.toolbar.subdirs[i].image);                    Appmenu.subdirPopupHash[this.toolbar.subdirs[i].name] = subDirItemPopup;                    Appmenu.subdirMenuHash[this.toolbar.subdirs[i].name] = subDirItem;
                }
            }
